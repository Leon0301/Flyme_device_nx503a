...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/mokee/volley/Request$Method;,
...
.field private k:Lcom/mokee/volley/RetryPolicy;

.field private final l:Lcom/mokee/volley/Response$ErrorListener;

.field private final m:Lcom/mokee/volley/VolleyLog$a;

.field private n:Lcom/mokee/volley/Cache$Entry;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "7\u0018\u001a*85\t\u001e/>8G\u0012k&!\u001fG >$\u0005G3#:\r\u0004%>2\r\u000e}q5\u0000\u000b4\"3\u001cW"
    ...
    const-string v1, "\u0013\u0006\t)5?\u0006\rf?9\u001cJ5$&\u0018\u00054%3\u000cPf"
    ...
    const-string v1, "1\r\u001e\u00154\'\u001d\u000f(23H\t\'=:\r\u000ef33\u000e\u000544v\u001b\u000f2\u00023\u0019\u001f#?5\r"
...
.method public constructor <init>(ILjava/lang/String;Lcom/mokee/volley/Response$ErrorListener;)V
    ...
    sget-boolean v3, Lcom/mokee/volley/Request;->e:Z

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-boolean v4, Lcom/mokee/volley/VolleyLog$a;->ENABLED:Z

    if-eqz v4, :cond_0

    new-instance v2, Lcom/mokee/volley/VolleyLog$a;

    invoke-direct {v2}, Lcom/mokee/volley/VolleyLog$a;-><init>()V

    :cond_0
    :try_start_0
    iput-object v2, p0, Lcom/mokee/volley/Request;->m:Lcom/mokee/volley/VolleyLog$a;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/mokee/volley/Request;->a:Z

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/mokee/volley/Request;->b:Z

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/mokee/volley/Request;->c:Z

    const-wide/16 v4, 0x0

    iput-wide v4, p0, Lcom/mokee/volley/Request;->j:J

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/mokee/volley/Request;->n:Lcom/mokee/volley/Cache$Entry;

    iput p1, p0, Lcom/mokee/volley/Request;->h:I

    iput-object p2, p0, Lcom/mokee/volley/Request;->i:Ljava/lang/String;

    iput-object p3, p0, Lcom/mokee/volley/Request;->l:Lcom/mokee/volley/Response$ErrorListener;
...
.method static synthetic access$1(Lcom/mokee/volley/Request;)Lcom/mokee/volley/VolleyLog$a;
    .locals 1

    iget-object v0, p0, Lcom/mokee/volley/Request;->m:Lcom/mokee/volley/VolleyLog$a;
...
.method public addMarker(Ljava/lang/String;)V
    ...
    :try_start_0
    sget-boolean v0, Lcom/mokee/volley/VolleyLog$a;->ENABLED:Z
    ...
    invoke-virtual {v0, p1, v2, v3}, Lcom/mokee/volley/VolleyLog$a;->add(Ljava/lang/String;J)V
    ...
    :cond_0
    :try_start_1
    iget-wide v0, p0, Lcom/mokee/volley/Request;->j:J
    :try_end_1
    .catch Ljava/lang/IllegalStateException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    iput-wide v0, p0, Lcom/mokee/volley/Request;->j:J
    :try_end_2
...
.method b(Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/mokee/volley/Request$a;

    invoke-direct {v3, p0, p1, v0, v1}, Lcom/mokee/volley/Request$a;-><init>(Lcom/mokee/volley/Request;Ljava/lang/String;J)V
    ...
    :cond_2
    iget-object v2, p0, Lcom/mokee/volley/Request;->m:Lcom/mokee/volley/VolleyLog$a;

    invoke-virtual {v2, p1, v0, v1}, Lcom/mokee/volley/VolleyLog$a;->add(Ljava/lang/String;J)V
    ...
    iget-wide v2, p0, Lcom/mokee/volley/Request;->j:J
...
.method public cancel()V
    ...
    iput-boolean v0, p0, Lcom/mokee/volley/Request;->b:Z
...
.method public compareTo(Lcom/mokee/volley/Request;)I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/mokee/volley/Request;->o:Ljava/lang/Integer;

    invoke-virtual {v0}, Ljava/lang/Integer;->intValue()I

    move-result v0

    iget-object v1, p1, Lcom/mokee/volley/Request;->o:Ljava/lang/Integer;
...
.method public deliverError(Lcom/mokee/volley/VolleyError;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/mokee/volley/Request;->l:Lcom/mokee/volley/Response$ErrorListener;
...
.method public getBody()[B
    ...
    invoke-virtual {p0}, Lcom/mokee/volley/Request;->getParams()Ljava/util/Map;
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/mokee/volley/Request;->getParamsEncoding()Ljava/lang/String;
...
.method public getCacheEntry()Lcom/mokee/volley/Cache$Entry;
    ...
    iget-object v0, p0, Lcom/mokee/volley/Request;->n:Lcom/mokee/volley/Cache$Entry;
...
.method public getMethod()I
    ...
    iget v0, p0, Lcom/mokee/volley/Request;->h:I
...
.method public getPostBody()[B
    ...
    invoke-virtual {p0}, Lcom/mokee/volley/Request;->getPostParams()Ljava/util/Map;
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/mokee/volley/Request;->getPostParamsEncoding()Ljava/lang/String;
...
.method public getRetryPolicy()Lcom/mokee/volley/RetryPolicy;
    ...
    iget-object v0, p0, Lcom/mokee/volley/Request;->k:Lcom/mokee/volley/RetryPolicy;
...
.method public getTag()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/mokee/volley/Request;->f:Ljava/lang/Object;
...
.method public getUrl()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/mokee/volley/Request;->i:Ljava/lang/String;
...
.method public hasHadResponseDelivered()Z
    ...
    iget-boolean v0, p0, Lcom/mokee/volley/Request;->c:Z
...
.method public isCanceled()Z
    ...
    iget-boolean v0, p0, Lcom/mokee/volley/Request;->b:Z
...
.method public markDelivered()V
    ...
    iput-boolean v0, p0, Lcom/mokee/volley/Request;->c:Z

    return-void
.end method

.method protected parseNetworkError(Lcom/mokee/volley/VolleyError;)Lcom/mokee/volley/VolleyError;
    .locals 0

    return-object p1
.end method

.method protected abstract parseNetworkResponse(Lcom/mokee/volley/NetworkResponse;)Lcom/mokee/volley/Response;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setCacheEntry(Lcom/mokee/volley/Cache$Entry;)Lcom/mokee/volley/Request;
    ...
    iput-object p1, p0, Lcom/mokee/volley/Request;->n:Lcom/mokee/volley/Cache$Entry;
...
.method public setRetryPolicy(Lcom/mokee/volley/RetryPolicy;)Lcom/mokee/volley/Request;
    ...
    iput-object p1, p0, Lcom/mokee/volley/Request;->k:Lcom/mokee/volley/RetryPolicy;
...
.method public final setSequence(I)Lcom/mokee/volley/Request;
    ...
    iput-object v0, p0, Lcom/mokee/volley/Request;->o:Ljava/lang/Integer;
...
.method public final setShouldCache(Z)Lcom/mokee/volley/Request;
    ...
    iput-boolean p1, p0, Lcom/mokee/volley/Request;->a:Z
...
.method public setTag(Ljava/lang/Object;)Lcom/mokee/volley/Request;
    ...
    iput-object p1, p0, Lcom/mokee/volley/Request;->f:Ljava/lang/Object;
...
.method public final shouldCache()Z
    ...
    iget-boolean v0, p0, Lcom/mokee/volley/Request;->a:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/mokee/volley/Request;->o:Ljava/lang/Integer;
